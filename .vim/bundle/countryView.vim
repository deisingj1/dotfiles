...
set helplang=en
set modelines=0
set runtimepath=~/.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/vim-airline,~/.vim/bundle/vim-buffergator,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,~/.vim/after
set showtabline=2
...
set shortmess=aoO
badd +23 ~/Java_Projects/CPS352/week6/countries.mph.tk/CountriesTester.java
badd +1 ~/Java_Projects/CPS352/week6/countries.mph.tk/Country.java
badd +1 ~/Java_Projects/CPS352/week6/countries.mph.tk/countries.csv
silent! argdel *
edit ~/Java_Projects/CPS352/week6/countries.mph.tk/CountriesTester.java
...
exe 'vert 3resize ' . ((&columns * 205 + 118) / 237)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
wincmd w
argglobal
edit ~/Java_Projects/CPS352/week6/countries.mph.tk/countries.csv
setlocal autoindent
setlocal nobinary
setlocal bufhidden=
setlocal buflisted
